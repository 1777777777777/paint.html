...
* Käyttäjä pystyy tykkäämään piirroksista. Klikkaamalla näkee kaikki tykkääjät. (CSS vielä kesken, joten näyttää paremmalta kun tykkää muiden kuin omien piirroksista)
